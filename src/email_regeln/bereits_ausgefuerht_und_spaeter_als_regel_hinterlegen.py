...
ZUORDNUNGEN2: dict[str, list[str]] = {
    ...
    "Folders/filter-andwendungen/gorillas": [
        "hello@gorillasapp.com",
        "news@newsletter.gorillasapp.de",
    ],
...
FOLDERS_TO_BE_CREATED2: list[str] = [
    "github",
    "airbnb",
    "gorillas",
    "spotify",
...
FOLDERS_TO_BE_CREATED4: list[str] = [
    #"booking-time",
    "google",
    "stadt-hamburg",
    #"mathpix",
...
ZUORDNUNGEN4: dict[str, list[str]] = {
    # --- Bestehende Ordner, neue Adressen ---
    "Folders/filter-andwendungen/openai": [
...
FOLDERS_TO_BE_CREATED7: list[str] = [
    "1a-visum",
    "1password",
    "activatio",
    "agoda",
...
ZUORDNUNGEN7: dict[str, list[str]] = {
...
ZUORDNUNGEN8: dict[str, list[str]] = {
    # --- Bestehende Ordner ---
...
ZUORDNUNGEN9: dict[str, list[str]] = {
    # =====================================================================
...
ZUORDNUNGEN10: dict[str, list[str]] = {
    # =====================================================================
    # BESTEHENDE ORDNER (bereits in filter-andwendungen vorhanden)
    # =====================================================================
