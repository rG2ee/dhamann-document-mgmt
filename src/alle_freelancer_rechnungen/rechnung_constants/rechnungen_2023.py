...
# rechnung, (betrag: netto, umsatzsteuer)
RECHNUNGEN_2023_BETRAG_STEUERN = OrderedDict((

    # Pleuger
    ("2022-12-LR", (7000, 0)),
    ("2023-01-LR", (5880, 1117.20)),

    # docu bot
    ("2023-09-lemonade-research", (4880.83, 927.36)),
    ("2023-10-lemonade-research", (4907.50, 932.43)),
    ("2023-11-lemonade-research", (2935.00, 557.65)),
    ("2023-12-lemonade-research", (4582.50, 870.68)),

    # human sign
    ("2023-001-gintech-ag", (2272.00, 0.00)),
    ("2023-002-gintech-ag", (5082.00, 0.00)),
    ("2023-003-gintech-ag", (5314.00, 0.00)),
    ("2023-004-gintech-ag", (4950.00, 0.00)),
    ("2023-005-gintech-ag", (2866.00, 0.00)),
))
